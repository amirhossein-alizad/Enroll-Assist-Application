...
public class SectionControllerTest {
    ...
    public void All_sections_are_returned_correctly() throws Exception {
        ...
        List<Section> sections = List.of(
                new Section(new Course("1111111", "C1", 3, "Undergraduate"), "01", exam1, Collections.emptySet()),
                new Section(new Course("2222222", "C2", 3, "Undergraduate"), "02", exam2, Collections.emptySet()),
                new Section(new Course("3333333", "C3", 3, "Undergraduate"), "01", exam1, Collections.emptySet())
        );
    ...
    public void Requested_section_is_returned_correctly() throws Exception {
        Section section = new Section(new Course("1111111", "ap", 3, "Undergraduate"), "01", exam1, Collections.emptySet());
    ...
    public void All_section_demands_are_returned_correctly() throws Exception {
        ...
        Section s1 = new Section(new Course("1111111", "C1", 3, "Undergraduate"), "01", exam1, Collections.emptySet());
        SectionView c1 = new SectionView(s1);
        SectionDemandView sd_1 = new SectionDemandView(c1, 50);
        Section s2 = new Section(new Course("2222222", "C2", 3, "Undergraduate"), "01", exam2, Collections.emptySet());
        SectionView c2 = new SectionView(s2);
        SectionDemandView sd_2 = new SectionDemandView(c2, 72);
        Section s3 = new Section(new Course("3333333", "C3", 3, "Undergraduate"), "01", exam3, Collections.emptySet());
    ...
    public void One_section_is_returned_correctly() throws Exception {
        Section section = new Section(new Course("1111111", "C1", 3, "Undergraduate"), "01", exam1, Collections.emptySet());
